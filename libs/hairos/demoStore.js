  ...
  social_posts: [
    {
      ...
      salon_id: DEMO_SALON_ID,
      content:
        "She walked in wanting a change. She left feeling like herself again. ✂️ Lived-in balayage + gloss + blowout — link in bio to book. #balayage #hairtransformation #behindthechair",
      image_urls: [],
    ...
    },
    {
      ...
      salon_id: DEMO_SALON_ID,
      content:
        "Color correction day: brassy ends → cool caramel in one session. If you are tired of box dye surprises, DM “FIX” and we will map a plan. #colorcorrection #healthyhair",
      image_urls: [],
    ...
    },
    {
      ...
      salon_id: DEMO_SALON_ID,
      content:
        "This Keratin Tuesday special filled in 48 hours last time. Smooth for 12 weeks, less blow-dry time behind the chair at home — tap to grab one of the last spots.",
      image_urls: [],
    ...
    },
    {
      ...
      salon_id: DEMO_SALON_ID,
      content:
        "Bridal trial season is here — soft waves, secure pins, zero stress. Tag a bride who deserves a calm morning before she walks down the aisle. #bridalhair #luxe",
      image_urls: [],
    ...
    },
    {
      ...
      salon_id: DEMO_SALON_ID,
      content:
        "Slow Tuesday? We texted 12 guests on the waitlist and filled two chairs by 4pm. Your guest list is an asset — we just help you use it. #salonowner #bookednbusy",
      image_urls: [],
      platforms: ["instagram", "tiktok"],
      scheduled_at: null,
      buffer_post_id: null,
