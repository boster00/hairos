// ARCHIVED: Original path was libs/content-magic/utils/cleanHtmlMarkers.js

/**
 * Remove markdown code block markers from HTML content (JavaScript version)
 */
export function cleanHtmlMarkers(html) {
