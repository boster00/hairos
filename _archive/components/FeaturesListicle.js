// ARCHIVED: Original path was components/FeaturesListicle.js
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-base-100 max-md:px-8 max-w-3xl">
          ...
          <div className="text-base-content/80 leading-relaxed mb-8 lg:text-lg">
            ...
            Track and improve how AI systems see your content. CJGEO helps you
            measure visibility, run reports, and optimize for AI search—so you
            stay discoverable where it matters.
          </div>
        </div>
      </div>
