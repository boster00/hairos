...
export const categories = [
  {
    ...
    description:
      "Here are the latest features we've added to CJGEO. We're constantly improving the product to help you track and improve AI visibility.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: "Latest features added to CJGEO.",
  },
  {
    ...
    description:
      "Learn how to use CJGEO with these step-by-step tutorials. We'll show you how to track visibility and optimize for AI search.",
    descriptionShort:
      "Learn how to use CJGEO with these step-by-step tutorials.",
  },
];
...
export const articles = [
  {
    ...
    title: "Introducing Supabase to CJGEO",
    // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
    description:
      "Supabase is an open-source Firebase alternative. It's a great tool for building a backend for your app. It's now integrated with CJGEO.",
    ...
    image: {
      ...
      alt: "Supabase and CJGEO logo combined",
    },
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
        ...
        <section>
          <h3 className={styles.h3}>2. Add your credentials to CJGEO</h3>
          <p className={styles.p}>
            Copy the <span className={styles.codeInline}>API URL</span> and{" "}
            <span className={styles.codeInline}>API Key</span> from your
            Supabase project settings and add them to your CJGEO project
